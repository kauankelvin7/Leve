...
export function ThemeSettings() {
  ...
  async function choose(colorTheme: ColorTheme) {
    const previousTheme = profile.colorTheme ?? 'green';
    ...
    } catch (error) { applyColorTheme(previousTheme); setMessage(error instanceof Error ? error.message : 'Não foi possível salvar a cor.'); }
